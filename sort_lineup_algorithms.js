/*
  ...
  #1  inser15Quicksort     9000000 elements in 1226 ms. 7341 el/ms.
  #2  bottomUpMergeSort    9000000 elements in 1362 ms. 6608 el/ms.
  #3  quicksortInward      9000000 elements in 1433 ms. 6281 el/ms.
  #4  quicksortForward     9000000 elements in 1901 ms. 4734 el/ms.
  #5  topDownMergeSort     7000000 elements in 3050 ms. 2295 el/ms.
  #6  heapsort             6000000 elements in 3617 ms. 1659 el/ms.
  #7  javascriptSort       5000000 elements in 4040 ms. 1238 el/ms.
  #8  insertionSort        90000 elements in 3128 ms. 29 el/ms.
  #9  selectionSort        80000 elements in 3032 ms. 26 el/ms.
  #10 bubbleSort           40000 elements in 5044 ms. 8 el/ms.
...
function topDownMergeSort(ar) {
  ...
  while (lefIx < lefAr.length) {
    ar[merIx++] = lefAr[lefIx++];
  }
  while (rigIx < rigAr.length) {
    ar[merIx++] = rigAr[rigIx++];
  }
  return ar;
}
...
while (testAr.length < testArLen) {
  ...
  while (i--) {
    testAr.push(testAr[y++]+testAr[x++] % 1);
  }
}
