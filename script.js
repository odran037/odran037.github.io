...
const elementsList = [
  ...
  },
  {
    target: body,
    elements: [
      { name: 'p', properties: [{ name: 'innerHTML', value: 'Be in this life as if you were a stranger or a traveler on a path.<br><br>If you reach the evening, do not expect to reach the morning, and if you reach the morning, do not expect to reach the evening. Take from your health before your sickness and from your life before your death.' }] }
    ]
  }
]
